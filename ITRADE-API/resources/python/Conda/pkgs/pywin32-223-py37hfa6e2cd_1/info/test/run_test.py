#  tests for pywin32-223-py37hfa6e2cd_1 (this is a generated file);
print('===== testing package: pywin32-223-py37hfa6e2cd_1 =====');
...
import win32ts
import win32wnet#  --- run_test.py (end) ---

print('===== pywin32-223-py37hfa6e2cd_1 OK =====');
