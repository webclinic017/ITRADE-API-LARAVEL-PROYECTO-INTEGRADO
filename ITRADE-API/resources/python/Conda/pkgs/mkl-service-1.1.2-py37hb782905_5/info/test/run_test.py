#  tests for mkl-service-1.1.2-py37hb782905_5 (this is a generated file);
print('===== testing package: mkl-service-1.1.2-py37hb782905_5 =====');
...
print('===== mkl-service-1.1.2-py37hb782905_5 OK =====');
print("import: 'mkl'")
import mkl
